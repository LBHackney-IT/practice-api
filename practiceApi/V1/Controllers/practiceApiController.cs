...
namespace practiceApi.V1.Controllers
{
    [ApiController]
    ...
    public class practiceApiController : BaseController
    {
        private readonly IGetAllUseCase _getAllUseCase;
        private readonly IGetByIdUseCase _getByIdUseCase;
        public practiceApiController(IGetAllUseCase getAllUseCase, IGetByIdUseCase getByIdUseCase)
        {
